package xueluoanping.dtbloomingnature.data;
...
import xueluoanping.dtbloomingnature.data.loot.DTFTLootTableProvider;

import java.util.concurrent.CompletableFuture;


public class start {
    public final static String MODID = DTBloomingNature.MOD_ID;
    ...
    public static void dataGen(GatherDataEvent event) {
        ...
        if (event.includeServer()) {
            DTBloomingNature.logger("Generate recipe");
