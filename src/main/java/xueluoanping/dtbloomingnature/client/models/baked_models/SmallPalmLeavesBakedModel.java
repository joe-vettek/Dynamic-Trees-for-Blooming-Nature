package xueluoanping.dtbloomingnature.client.models.baked_models;
...
public class SmallPalmLeavesBakedModel implements IDynamicBakedModel {
    ...
    public SmallPalmLeavesBakedModel(ResourceLocation modelResLoc, ResourceLocation frondsResLoc){
